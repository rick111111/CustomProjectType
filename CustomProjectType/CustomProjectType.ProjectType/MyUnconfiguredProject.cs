...
namespace CustomProjectType
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "CustomProjectType", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "cusproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "CustomProjectType";

        internal const string Language = "CustomProjectType";
